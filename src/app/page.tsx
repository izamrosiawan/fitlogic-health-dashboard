        ...
        <section className="max-w-7xl mx-auto px-6 pt-16 pb-20 md:pt-28 md:pb-36 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <Link href="/login">
                <Button variant="outline" className="border-neutral-800 bg-neutral-900/40 hover:bg-neutral-900 text-neutral-200 font-bold px-8 py-6 rounded-xl text-base cursor-pointer">
                  Try Demo Account
                </Button>
              </Link>
            </div>
